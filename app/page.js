  ...
  return (
   <>
    ...
    {/* <Nav handlemenu={handleShowMenu}/> */}
      ...
      <Reward/>
      <Footer/>
      <Image src={purpleblurbg} alt='bg' className="w-[200px] absolute top-[5%] md:rounded-none rounded-full right-[0] md:hidden"/>
        <Image src={purpleblurbg} alt='bg' className="max-w-[350px] z-0 w-[250px] absolute rotate-45 top-[0] left-0"/>
