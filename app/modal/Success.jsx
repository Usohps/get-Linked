...
function Success({closeModal}) {
  return (
    <div className=" w-full h-full flex justify-center fixed top-[0] backdrop-blur-sm animation  left-0 from-transparent to-[#253D62]">
      ...
      <div className="border"><AiOutlineClose size={24} className="text-white" onClick={closeModal}  /></div>
