...
function QuestionSection() {
  return (
    <>
      ...
      >
        <div className="w-full z-10 md:text-end text-center my-32 italic p-12 text-xl  relative">
          <div className="z-20">
          ...
          <Image
            src={Star}
            alt="star"
            className=" absolute md:top-50 md:left-10 left-52 bottom-20 "
          />
        </div>
      </motion.div>
      <section className=" flex items-center relative space-y-9 gap-7 justify-between container m-auto flex-col md:flex-row">
        ...
        >
          <div className="max-w-[500px] relative p-4 flex items-center justify-center">
            ...
            <Image
              src={Image1}
              alt="image1"
              className="w-full absolute right-0 top-4"
            />
          </div>
        </motion.div>
        ...
        <Image
          src={Star}
          alt="star"
          className="absolute bottom-[65%] right-[20%] md:bottom-20 md:left-[50%]  "
        />
      </section>
        ...
        <div className="max-w-[500px] m-auto space-y-6">
          <div className="p-4 relative">
            ...
            <p>
              ...
              coding genius, a design maverick, or a concept wizard, you all
