  ...
  return (
    <>
      <div className="w-full md:text-end text-center py-32 italic p-12 text-xl  relative">
        ...
        />
        <Image src={Star} className=" absolute md:top-50 md:left-10 left-52 bottom-20 " />
      </div>
      <section className=" flex items-center relative space-y-9 gap-7 justify-between container m-auto flex-col md:flex-row">
        <div className="max-w-[500px] m-auto flex-col flex items-center md:block space-y-6">
          <div className="p-4">
            <Image src={Title} placeholder="blur" />
            <p>
        ...
        <div className="max-w-[500px] relative p-4 flex items-center justify-center">
          ...
          <Image src={Image1} className="w-full absolute right-0 top-4" />
        </div>
        <Image src={Star} className="absolute top-0 left-[50%] " />
        <Image src={Star} className="absolute bottom-[65%] right-[20%] md:bottom-20 md:left-[50%]  " />
      </section>
      <section className=" flex items-center space-y-9 gap-7 justify-between container m-auto flex-col-reverse md:flex-row">
        <div className="max-w-[500px] relative p-4 flex items-center justify-center relative">
          <Image src={Lightbulb} placeholder="blur" className="w-full" />
          <Image src={Star} className="absolute top-[40%] left-5 " />
        </div>
        <div className="max-w-[500px] m-auto space-y-6">
          <div className="p-4 relative">
            ...
            <Image src={Star} className="absolute top-[40%] right-0 " />
          </div>
        </div>
      </section>
      <section className=" flex items-center  space-y-9 gap-7 justify-between container m-auto flex-col-reverse md:flex-row">
        ...
        <div className="max-w-[500px] p-4 flex items-center justify-center relative">
          <Image src={Lady} className="w-full" />
        </div>
      </section>
      <div className="flex items-center  space-y-9 gap-7 justify-between container m-auto flex-col md:flex-row">
        <div className="max-w-[400px] pt-24 flex items-center justify-center relative">
          <Image src={QuestionImg2} placeholder="blur" className="w-full" />
        </div>
      ...
      <div className=" w-full text-center  relative md:max-w-[500px] md:m-auto   p-4">
          <Image src={Star} className="absolute top-0 left-10 " />
      ...
      <div className="flex items-center space-y-9 gap-7 justify-between container m-auto flex-col md:flex-row">
        ...
        <div className="max-w-[400px] pt-24 flex items-center justify-center relative">
          <Image src={QuestionHero} placeholder="blur" className="w-full" />
          <Image
            src={Questionmark1}
            placeholder="blur"
          ...
          />
          <Image src={Star} className="absolute top-10 left-[35%] " />
        <Image src={Star} className="absolute top-10 right-[35%] " />
        <Image src={Star} className="absolute bottom-0 right-[50%] " />
        <Image src={Star} className="absolute bottom-[50%] left-[0] " />
        </div>
