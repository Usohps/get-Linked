  ...
  return (
    <div className=" container m-auto  space-y-1 py-12 pl-4 md:pl-0">
      ...
      <div className="relative  flex md:container flex-col md:flex-row md:items-center justify-center">
        <div className="flex">
          <div className="flex flex-row-reverse md:flex-row md:w-[300px] md:h-[400px] m-auto">
            <div className="space-y-4 p-8 relative">
              <Image src={Star} alt="" className="absolute top-0 left-[0] " />
        ...
        <div className="  md:w-[300px] flex items-center md:h-[400px] lg:w-[470px] pl-6  md:p-8 absolute left-10 bottom-0 md:bottom-0 md:left-0 md:relative">
      ...
      <div className="relative space-y-5 flex md:container flex-col md:flex-row-reverse md:items-center justify-center">
        <div className="flex ">
          <div className="flex flex-row-reverse  md:w-[367px] lg:w-[550px] md:h-[400px] m-auto">
        ...
        <div className=" md:w-[300px] md:h-[400px] lg:w-[320px] flex items-center pl-6 md:p-8 absolute left-10 bottom-2 md:bottom-0 md:left-0 md:relative">
          <h1>November 18, 2023</h1>
        </div>
      </div>
